...
- 🧩 Currently deepening my skills in **C#, .NET, MySQL and web development**.
- 🌿 Built **EcoMap**, a web app to locate recycling centers and log recycling actions.

## 🌿 Featured Project

**EcoMap** — a web app to find nearby recycling centers and track users' recycling actions.

- **[Live Demo](https://djmnzzz.github.io/EcoMap/index.html)** 🚧 *preview only — not yet fully deployed*
- **[Repository](https://github.com/djmnzzz/EcoMap.git)**
...
- Introduction to Data Science — Badge & Certificate, Cisco Networking Academy (2026)
- Introduction to IoT — Badge & Certificate, Cisco Networking Academy (2025)

## 📬 Contact

[dani05jimenez20@gmail.com](mailto:dani05jimenez20@gmail.com)
